...
contract Comptroller is ComptrollerV5Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
     ...
     */
    function claim(address holder, CToken[] memory cTokens) public {
        address[] memory holders = new address[](1);
        holders[0] = holder;
        claim(holders, cTokens, true, true);
    }
     ...
     */
    function claim(address[] memory holders, CToken[] memory cTokens, bool borrowers, bool suppliers) public {
    ...
    function getCompAddress() public view returns (address) {
        return 0x5c8e142603D64ecfC6354587166fc38eD731b50a;
    }
}